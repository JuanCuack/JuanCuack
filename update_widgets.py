...
# Instancia propia en Vercel (100% privada con 5000 req/h)
VERCEL_BASE = "https://github-readme-stats-psi-swart-54.vercel.app"
    ...
    for name, url in WIDGETS.items():
        try:
            ...
            if is_valid_svg:
                ...
                print(f"⚠️ {name} saltado (Error o respuesta no válida: {response.status_code}).")
